...
def make_args():
    ...
    parser.add_argument('--save_dir', type=str, default='output_m_crd', help='architecture name')
    parser.add_argument('--save_dir_crd', type=str, default='output_s_crd_75k', help='architecture name') #output_s_crd_225
...
class Trainer:
    ...
    def distillation_crd(self, T, alpha):
        self.best_acc = 0
        train_acc_crd =[]
        train_loss_crd = []
        val_acc_crd = []
...
if __name__ == '__main__':
    ...
    trainer.train()
    trainer.distillation_crd(T=5, alpha=0.6)